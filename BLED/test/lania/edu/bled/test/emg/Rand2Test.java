...
import lania.edu.bled.de.mutation.Rand2;
...
public class Rand2Test {
    ...
    public void PU72(){
        ...
        Rand2 rand2 = new Rand2();
        List<Solution> mutants = rand2.getMutants(F, soluciones, P);
    ...
    public void PU75(){
        ...
        double[] Cr = {};
        List<Solution> soluciones = rand2.getMutants(Cr, targets, P);
    }
}
