...
import lania.edu.bled.optimization.problems.cec2017.C25;
 ...
 * @author esteb
 */
public class TestIntegrationC25_2017 {
    
    public TestIntegrationC25_2017() {
    }
    ...
    public void PI165() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C25 C25 = new C25(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C25);
    ...
    public void PI166() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C25 C25 = new C25(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C25);
    ...
    public void PI167() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C25 C25 = new C25(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C25);
    ...
    public void PI168() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C25 C25 = new C25(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C25);
