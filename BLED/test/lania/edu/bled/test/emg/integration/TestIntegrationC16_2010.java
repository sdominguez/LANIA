...
import lania.edu.bled.optimization.problems.cec2010.C16;
 ...
 * @author esteb
 */
public class TestIntegrationC16_2010 {
    
    public TestIntegrationC16_2010() {
    }
    ...
    public void PI57() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C16 C16 = new C16(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C16);
    ...
    public void PI58() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C16 C16 = new C16(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C16);
    ...
    public void PI59() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C16 C16 = new C16(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C16);
    ...
    public void PI60() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C16 C16 = new C16(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C16);
