...
import lania.edu.bled.optimization.problems.cec2017.C20;
 ...
 * @author esteb
 */
public class TestIntegrationC20_2017 {
    
    public TestIntegrationC20_2017() {
    }
    ...
    public void PI145() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C20 C20 = new C20(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C20);
    ...
    public void PI146() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C20 C20 = new C20(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C20);
    ...
    public void PI147() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C20 C20 = new C20(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C20);
    ...
    public void PI148() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C20 C20 = new C20(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C20);
