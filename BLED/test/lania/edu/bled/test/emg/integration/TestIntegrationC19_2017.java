 ...
 * @author esteb
 */
public class TestIntegrationC19_2017 {
    
    public TestIntegrationC19_2017() {
    }
    ...
    public void PI141() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C19 C19 = new C19(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C19);
    ...
    public void PI142() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C19 C19 = new C19(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C19);
    ...
    public void PI143() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C19 C19 = new C19(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C19);
    ...
    public void PI144() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C19 C19 = new C19(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C19);
