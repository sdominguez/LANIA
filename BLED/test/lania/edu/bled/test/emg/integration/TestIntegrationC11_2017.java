...
import lania.edu.bled.optimization.problems.cec2017.C11;
 ...
 * @author esteb
 */
public class TestIntegrationC11_2017 {
    
    public TestIntegrationC11_2017() {
    }
    ...
    public void PI109() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C11 C11 = new C11(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C11);
    ...
    public void PI110() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C11 C11 = new C11(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C11);
    ...
    public void PI111() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C11 C11 = new C11(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C11);
    ...
    public void PI112() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C11 C11 = new C11(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C11);
