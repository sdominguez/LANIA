...
import lania.edu.bled.optimization.problems.cec2017.C26;
 ...
 * @author esteb
 */
public class TestIntegrationC26_2017 {
    
    public TestIntegrationC26_2017() {
    }
    ...
    public void PI169() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C26 C26 = new C26(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C26);
    ...
    public void PI170() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C26 C26 = new C26(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C26);
    ...
    public void PI171() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C26 C26 = new C26(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C26);
    ...
    public void PI172() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C26 C26 = new C26(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C26);
