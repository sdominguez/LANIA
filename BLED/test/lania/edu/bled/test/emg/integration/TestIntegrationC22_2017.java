 ...
 * @author esteb
 */
public class TestIntegrationC22_2017 {
    
    public TestIntegrationC22_2017() {
    }
    ...
    public void PI153() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C22 C22 = new C22(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C22);
    ...
    public void PI154() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C22 C22 = new C22(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C22);
    ...
    public void PI155() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C22 C22 = new C22(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C22);
    ...
    public void PI156() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C22 C22 = new C22(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C22);
