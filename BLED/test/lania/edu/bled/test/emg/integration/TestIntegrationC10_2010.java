 ...
 * @author esteb
 */
public class TestIntegrationC10_2010 {
    
    public TestIntegrationC10_2010() {
    }
    ...
    public void PI33() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C10 C10 = new C10(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C10);
    ...
    public void PI34() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C10 C10 = new C10(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C10);
    ...
    public void PI35() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C10 C10 = new C10(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C10);
    ...
    public void PI36() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C10 C10 = new C10(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C10);
