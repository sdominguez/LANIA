...
import lania.edu.bled.optimization.problems.cec2017.C14;
 ...
 * @author esteb
 */
public class TestIntegrationC14_2017 {
    
    public TestIntegrationC14_2017() {
    }
    ...
    public void PI121() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C14 C14 = new C14(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C14);
    ...
    public void PI122() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C14 C14 = new C14(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C14);
    ...
    public void PI123() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C14 C14 = new C14(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C14);
    ...
    public void PI124() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C14 C14 = new C14(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C14);
