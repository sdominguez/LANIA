...
import lania.edu.bled.optimization.problems.cec2010.C15;
 ...
 * @author esteb
 */
public class TestIntegrationC15_2010 {
    
    public TestIntegrationC15_2010() {
    }
    ...
    public void PI53(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C15 C15 = new C15(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C15);
    ...
    //Problema C15 con tamaño de 30 dimensiones
    @Test
    public void PI54(){ 
        System.out.println("\n PI-54");
        int totalRuns = 25;
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C15 C15 = new C15(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C15);
            rand1.initializePopulation();
            rand1.run();
            Solution bestSolution = rand1.getOutput().getBestSolution();
            double [] g = bestSolution.getG();
    ...
    public void PI55(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C15 C15 = new C15(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C15);
    ...
    public void PI56(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C15 C15 = new C15(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C15);
            rand2.initializePopulation();
            rand2.run();
            Solution bestSolution = rand2.getOutput().getBestSolution();
            double [] g = bestSolution.getG();
