 ...
 * @author esteb
 */
public class TestIntegrationC04_2017 {
    
    public TestIntegrationC04_2017() {
    }
    ...
    public void PI81(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C04 C04 = new C04(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C04);
    ...
    //Problema C04 con tamaño de 30 dimensiones
    @Test
    public void PI82(){ 
        System.out.println("\n PI-82");
        int totalRuns = 25;
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C04 C04 = new C04(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C04);
            rand1.initializePopulation();
            rand1.run();
            Solution bestSolution = rand1.getOutput().getBestSolution();
            double [] g = bestSolution.getG();
    ...
    public void PI83(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C04 C04 = new C04(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C04);
    ...
    public void PI84(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C04 C04 = new C04(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C04);
            rand2.initializePopulation();
            rand2.run();
            Solution bestSolution = rand2.getOutput().getBestSolution();
            double [] g = bestSolution.getG();
