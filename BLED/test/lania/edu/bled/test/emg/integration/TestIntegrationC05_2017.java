...
import lania.edu.bled.optimization.problems.cec2017.C05;
 ...
 * @author esteb
 */
public class TestIntegrationC05_2017 {
    
    public TestIntegrationC05_2017() {
    }
    ...
    public void PI85(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C05 C05 = new C05(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C05);
    ...
    //Problema C05 con tamaño de 30 dimensiones
    @Test
    public void PI86(){ 
        System.out.println("\n PI-86");
        int totalRuns = 25;
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C05 C05 = new C05(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C05);
            rand1.initializePopulation();
            rand1.run();
            Solution bestSolution = rand1.getOutput().getBestSolution();
            double [] g = bestSolution.getG();
    ...
    public void PI87(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C05 C05 = new C05(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C05);
    ...
    public void PI88(){ 
        ...
        for (int run = 1; run <= totalRuns; run++) {
            System.out.println("Ejecucion numero: " + run);
            C05 C05 = new C05(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C05);
            rand2.initializePopulation();
            rand2.run();
            Solution bestSolution = rand2.getOutput().getBestSolution();
            double [] g = bestSolution.getG();
