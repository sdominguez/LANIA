 ...
 * @author esteb
 */
public class TestIntegrationC24_2017 {
    
    public TestIntegrationC24_2017() {
    }
    ...
    public void PI161() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C24 C24 = new C24(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C24);
    ...
    public void PI162() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C24 C24 = new C24(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C24);
    ...
    public void PI163() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C24 C24 = new C24(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C24);
    ...
    public void PI164() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C24 C24 = new C24(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C24);
