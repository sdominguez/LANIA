...
import lania.edu.bled.optimization.problems.cec2017.C21;
 ...
 * @author esteb
 */
public class TestIntegrationC21_2017 {
    
    public TestIntegrationC21_2017() {
    }
    ...
    public void PI149() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C21 C21 = new C21(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C21);
    ...
    public void PI150() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C21 C21 = new C21(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C21);
    ...
    public void PI151() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C21 C21 = new C21(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C21);
    ...
    public void PI152() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C21 C21 = new C21(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C21);
