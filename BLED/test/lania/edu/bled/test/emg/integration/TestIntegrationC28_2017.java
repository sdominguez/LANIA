 ...
 * @author esteb
 */
public class TestIntegrationC28_2017 {
    
    public TestIntegrationC28_2017() {
    }
    ...
    public void PI177() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C28 C28 = new C28(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C28);
    ...
    public void PI178() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C28 C28 = new C28(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C28);
    ...
    public void PI179() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C28 C28 = new C28(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C28);
    ...
    public void PI180() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C28 C28 = new C28(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C28);
