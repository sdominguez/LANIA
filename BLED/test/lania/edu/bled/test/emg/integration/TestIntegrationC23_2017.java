...
import lania.edu.bled.optimization.problems.cec2017.C23;
 ...
 * @author esteb
 */
public class TestIntegrationC23_2017 {
    
    public TestIntegrationC23_2017() {
    }
    ...
    public void PI157() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C23 C23 = new C23(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C23);
    ...
    public void PI158() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C23 C23 = new C23(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C23);
    ...
    public void PI159() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C23 C23 = new C23(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C23);
    ...
    public void PI160() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C23 C23 = new C23(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C23);
