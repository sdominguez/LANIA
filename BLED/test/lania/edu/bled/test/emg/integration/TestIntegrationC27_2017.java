...
import lania.edu.bled.optimization.problems.cec2017.C27;
 ...
 * @author esteb
 */
public class TestIntegrationC27_2017 {
    
    public TestIntegrationC27_2017() {
    }
    ...
    public void PI173() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C27 C27 = new C27(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, C27);
    ...
    public void PI174() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C27 C27 = new C27(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, C27);
    ...
    public void PI175() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C27 C27 = new C27(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, C27);
    ...
    public void PI176() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C27 C27 = new C27(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, C27);
