...
import lania.edu.bled.optimization.problems.cec2017.C03;
 ...
 * @author esteb
 */
public class TestIntegrationC03_2017 {
    
    public TestIntegrationC03_2017() {
    }
    ...
    public void PI77() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C03 c03 = new C03(10);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 200000, c03);
    ...
    public void PI78() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C03 c03 = new C03(30);
            DERand1Bin rand1 = new DERand1Bin(20, 0.5, 0.9, 600000, c03);
    ...
    public void PI79() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C03 c03 = new C03(10);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 200000, c03);
    ...
    public void PI80() {
        ...
        for (int run = 1; run <= totalRuns; run++) {
            ...
            C03 c03 = new C03(30);
            DERand2Bin rand2 = new DERand2Bin(20, 0.5, 0.9, 600000, c03);
