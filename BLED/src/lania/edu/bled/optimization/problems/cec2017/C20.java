 ...
 * @author sdominguez
 */
public class C20 extends ConstrainedProblem{
    ...
    public Solution evaluate(Solution s) {
        ...
        for (i = 0; i < (nx - 1); i++) {
            f2 = f2 + (0.5 * Math.pow(Math.sin(Math.sqrt(Math.pow(e[i], 2) + Math.pow(e[i+1], 2))), 2) - 0.5/Math.pow(1+0.001*Math.sqrt(Math.pow(e[i], 2) + Math.pow(e[i+1], 2)), 2));
        }
        
        f3 = (0.5 * Math.pow(Math.sin(Math.sqrt(Math.pow(e[nx-1], 2) + Math.pow(e[0], 2))), 2) - 0.5/Math.pow(1+0.001*Math.sqrt(Math.pow(e[nx-1], 2) + Math.pow(e[0], 2)), 2));
        f1 = f2 + f3;
        ...
        g1 = Math.pow(Math.cos(g3), 2) - 0.25 * Math.cos(g3) - 0.125;
        g2 = Math.exp(Math.cos(g3)) - Math.exp(0.25);
